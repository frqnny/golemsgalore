...
public class SpiderGolemEntityModel<T extends Entity> extends SinglePartEntityModel<T> {
    /**
    ...
    public SpiderGolemEntityModel(ModelPart root) {
        this.root = root;
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("nose", ModelPartBuilder.create().uv(56, 26).cuboid(-1.0f, 1.0f, -10.0f, 2F, 4F, 2F), ModelTransform.pivot(0.0F, 15.0f, -3.0f));
    ...
    public void setAngles(T entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        ...
        this.nose.yaw = headYaw * ((float) Math.PI / 180);
        this.nose.pitch = headPitch * ((float) Math.PI / 180);
